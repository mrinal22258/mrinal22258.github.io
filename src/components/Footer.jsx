...
import { FiGithub, FiLinkedin, FiCpu, FiShield, FiActivity, FiArrowUpRight } from 'react-icons/fi';
...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FiGithub />, label: 'GITHUB', url: 'https://github.com/mrinal22258', color: 'hover:text-white' },
    { icon: <FiLinkedin />, label: 'LINKEDIN', url: 'https://www.linkedin.com/in/krmrinal/', color: 'hover:text-blue-500' },
  ];
...
KR_<span className="text-cyan-600">MRINAL</span>
              </h3>
            </div>
        ...
        <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-end">
             ...
             <p className="text-[9px] text-gray-700 tracking-[0.2em] font-mono uppercase">
                &copy; KUMAR MRINAL. IIIT DELHI 2022-2026.
             </p>
          </div>
        </div>
      </div>
